...
public class EscalamientoTicketController {
    ...
    @PostMapping
    public ResponseEntity<EscalamientoTicket> crear(@Valid @RequestBody EscalamientoRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.crear(request));
    }

    @PutMapping("/{id}/gestionar")
    public ResponseEntity<EscalamientoTicket> gestionar(@PathVariable Long id, @Valid @RequestBody GestionarEscalamientoRequest request) {
        return ResponseEntity.ok(service.gestionar(id, request));
    }

    @PutMapping("/{id}/cerrar")
    public ResponseEntity<EscalamientoTicket> cerrar(@PathVariable Long id, @Valid @RequestBody CerrarEscalamientoRequest request) {
