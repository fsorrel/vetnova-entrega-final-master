...
import cl.vetnova.auth.dto.ErrorResponse;
...
public class GlobalExceptionHandlerTest {
    ...
    void testNotFoundResponde404() {
        ...
        assertFalse(respuesta.getBody().success());
        assertNotNull(respuesta.getBody().message());
    }

    @Test
    void testConflictResponde409() {
        ResponseEntity<ErrorResponse> respuesta = handler.conflict(new ConflictException("recurso duplicado"), request);
    ...
    void testInmutableResponde405() {
        ResponseEntity<ErrorResponse> respuesta = handler.inmutable(new RegistroInmutableException("no se puede modificar"), request);
    ...
    @Test
    void testUnauthorizedResponde401() {
        ResponseEntity<ErrorResponse> respuesta = handler.unauthorized(new UnauthorizedException("Credenciales inválidas"), request);
    ...
    void testBusinessResponde400() {
        ResponseEntity<ErrorResponse> respuesta = handler.business(new BusinessRuleException("regla de negocio incumplida"), request);
    ...
    @Test
    void testConstraintResponde400() {
        ResponseEntity<ErrorResponse> respuesta = handler.constraint(new ConstraintViolationException("dato invalido", Set.of()), request);
