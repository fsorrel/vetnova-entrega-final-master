...
private WebClient webClient;
    ...
    @Test
    void testAvisarCambioEstadoEnviaLaNotificacion() {
        ...
        assertDoesNotThrow(() -> client.avisarCambioEstado(2L, 1L, "EN_RUTA"));
    }

    @Test
    void testAvisarCambioEstadoConNotificacionesCaidoNoRompeElFlujo() {
        NotificacionesClient client = new NotificacionesClient(builderSimulado(), "http://localhost:8092");
