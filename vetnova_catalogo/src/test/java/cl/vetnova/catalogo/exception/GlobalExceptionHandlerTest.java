...
import cl.vetnova.catalogo.dto.ErrorResponse;
...
public class GlobalExceptionHandlerTest {
    ...
    void testBusinessResponde400() {
        ResponseEntity<ErrorResponse> respuesta = handler.business(new BusinessRuleException("regla incumplida"), request);
